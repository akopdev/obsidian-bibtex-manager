...
export const cslList: Array<CSLItem> = [
	{
	...
	{
		label: "Aix-Marseille Université - Département d'études asiatiques (Français)",
	...
	{
		label: "American Psychological Association 6th edition (Provost) (Français - Canada)",
		id: "apa-fr-provost",
	...
	{
		label: "Escola de Comando e Estado-Maior do Exército - ABNT (Português - Brasil)",
	...
	{
		label: "Escola de Comando e Estado-Maior do Exército - Instituto Meira Mattos - ABNT (Português - Brasil)",
	...
	{
		label: "Instituto de Pesquisa Econômica Aplicada - ABNT (Português - Brasil)",
	...
	{
		label: "Associação Brasileira de Normas Técnicas (note, Português - Brasil)",
	...
	{
		label: "Universidade Federal de Minas Gerais - Faculdade de Ciências Econômicas - ABNT (autoria completa) (Português - Brasil)",
	...
	{
		label: "Universidade Federal de Minas Gerais - Faculdade de Ciências Econômicas - ABNT (autoria abreviada) (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Rio Grande do Sul - ABNT (autoria abreviada) (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Rio Grande do Sul - ABNT (autoria abreviada, nota, com Ibid.) (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Rio Grande do Sul - ABNT (autoria completa) (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Estado do Rio de Janeiro - Educação Infantil e Políticas Públicas - ABNT (Português - Brasil)",
	...
	{
		label: "Universidade de São Paulo - Faculdade de Medicina Veterinária e Zootecnia - ABNT (Português - Brasil)",
	...
	{
		label: "ANPET - Congresso de Pesquisa e Ensino em Transportes (Português - Brasil)",
	...
	{
		label: "Austrian Journal of Development Studies (Journal für Entwicklungspolitik)",
	...
	{
		label: "AZR - Abkürzungs- und Zitierregeln der österreichischen Rechtssprache und europarechtlicher Rechtsquellen (Deutsch - Österreich)",
	...
	{
		label: "Babes-Bolyai University - Faculty of Orthodox Theology (no ibid., Română)",
	...
	{
		label: "Bibliothèque d'archéologie méditerranéenne et africaine (BiAMA) (Français)",
	...
	{
		label: "Campus adventiste du Salève - Faculté adventiste de théologie (Français)",
	...
	{
		label: "Centre de recherche sur les civilisations de l’Asie orientale (Français - Auteur, Date)",
	...
	{
		label: "Centre de recherche sur les civilisations de l'Asie orientale (Français - note)",
	...
	{
		label: "Česká zemědělská univerzita v Praze - Fakulta agrobiologie, potravinových a přírodních zdrojů",
	...
	{
		label: "Chroniques des activités archéologiques de l'Ecole française de Rome",
	...
	{
		label: "Cuadernos de Filología Clásica. Estudios Griegos e Indoeuropeos (autor-año, Español)",
	...
	{
		label: "Donau-Universität Krems - Department für E-Governance in Wirtschaft und Verwaltung (Deutsch - Österreich)",
	...
	{
		label: "École Pratique des Hautes Études - Sciences historiques et philologiques (Français)",
	...
	{
		label: "Escuela Nacional de Antropología e Historia (autor-fecha, Español - México)",
	...
	{
		label: "Escuela Nacional de Antropología e Historia (nota completa, Español - México)",
	...
	{
		label: "Escuela Nacional de Antropología e Historia (nota corta, Español - México)",
	...
	{
		label: "Facoltà Teologica dell'Italia Settentrionale - Milano (titoli di riviste non abbreviati, Italiano)",
	...
	{
		label: "Frattura ed Integrità Strutturale - Fracture and Structural Integrity",
	...
	{
		label: "Friedrich-Schiller-Universität Jena - Medizinische Fakultät (Deutsch)",
	...
	{
		label: "Georg-August-Universität Göttingen - Institut für Ethnologie und Ethnologische Sammlung (Deutsch)",
	...
	{
		label: "Guide des citations, références et abréviations juridiques 6e édition (Français)",
	...
	{
		label: "Guide pour la rédaction et la présentation des thèses à l'usage des doctorants (Français)",
	...
	{
		label: "Gesellschaft für Bildung und Forschung in Europa - Harvard (Deutsch)",
	...
	{
		label: "Institut für Praxisforschung - Harvard (Bahr & Frackmann) (Deutsch)",
	...
	{
		label: "Heidelberg University - Faculty of Medicine (Universität Heidelberg - Medizinische Fakultät Heidelberg)",
	...
	{
		label: "Hochschule München - Fakultät für Angewandte Sozialwissenschaften (Deutsch)",
	...
	{
		label: "Hochschule Osnabrück - Fakultät Agrarwissenschaften und Landschaftsarchitektur (Deutsch)",
	...
	{
		label: "Időjárás - Quarterly Journal of the Hungarian Meteorological Service",
	...
	{
		label: "Institut français d'archéologie orientale - études arabes (Français)",
	...
	{
		label: "Institut français d'archéologie orientale - archéologie et égyptologie (Français)",
	...
	{
		label: "Institut national de la recherche scientifique - Sciences sociales (author-date, Français)",
	...
	{
		label: "Institut national de recherches archéologiques préventives (Français)",
	...
	{
		label: "Institut national de santé publique du Québec - NAPP (Français - Canada)",
	...
	{
		label: "Institut national de santé publique du Québec - TOPO (Français - Canada)",
	...
	{
		label: "Instituto Brasileiro de Informação em Ciência e Tecnologia - ABNT (autoria abreviada)",
	...
	{
		label: "Instituto Brasileiro de Informação em Ciência e Tecnologia - ABNT (autoria completa)",
	...
	{
		label: "Instituto de Investigaciones sobre la Universidad y la Educación - Moderno (autor-fecha, Español)",
	...
	{
		label: "Instituto de Pesquisas Energéticas e Nucleares (Português - Brasil)",
	...
	{
		label: "Inventaire général du patrimoine culturel - ISO-690 (full note, with Ibid., Français)",
	...
	{
		label: "Inventaire général du patrimoine culturel - ISO-690 (full note, Français)",
	...
	{
		label: "Inventaire général du patrimoine culturel - ISO-690 (note, Français)",
	...
	{
		label: "İzmir Katip Çelebi Üniversitesi - Sosyal Bilimler Enstitüsü (Türkçe)",
	...
	{
		label: "Juristische Zitierweise Schweizer (Ryser Büschi et al.) (Deutsch - Schweiz)",
	...
	{
		label: "KIT Karlsruher Institut für Technologie Germanistik NDL Neuere Deutsche Literaturwissenschaft (German)",
	...
	{
		label: "Lauterbornia - Internationale Zeitschrift für Faunistik und Floristik des Süßwassers (Deutsch)",
		id: "lauterbornia",
	...
	{
		label: "Le tapuscrit (École des hautes études en sciences sociales) (author-date, Français)",
	...
	{
		label: "Le tapuscrit (École des hautes études en sciences sociales) (note, Français)",
	...
	{
		label: "Guide des références pour la rédaction juridique 7e édition (Notes complètes) (Guide Lluelles, no Ibid., Français - Canada)",
		id: "lluelles-no-ibid",
		value: "https://raw.githubusercontent.com/citation-style-language/styles/master/lluelles-no-ibid.csl",
	},
	{
		label: "Guide des références pour la rédaction juridique 7e édition (Guide Lluelles, Français - Canada)",
		id: "lluelles",
	...
	{
		label: "Manuel canadien de la référence juridique 9e édition (Guide McGill, Français - Canada)",
		id: "mcgill-fr",
	...
	{
		label: "Mercator-Institut für Sprachförderung und Deutsch als Zweitsprache (Deutsch)",
	...
	{
		label: "Necmettin Erbakan Üniversitesi Fen ve Mühendislik Bilimleri Dergisi (Türkçe)",
	...
	{
		label: "Norsk henvisningsstandard for rettsvitenskapelige tekster (Norsk - Bokmål)",
	...
	{
		label: "Österreichische Zeitschrift für Politikwissenschaft (Deutsch - Österreich)",
	...
	{
		label: "Otto-von-Guericke-Universität Magdeburg - Medizinische Fakultät (numeric)",
	...
	{
		label: "Pädagogische Hochschule Bern - Institut Vorschulstufe und Primarstufe",
	...
	{
		label: "Pädagogische Hochschule Fachhochschule Nordwestschweiz (Deutsch - Schweiz)",
	...
	{
		label: "Philipps-Universität Marburg - Erziehungswissenschaften (note, Deutsch)",
	...
	{
		label: "Presses Universitaires de Rennes - Archéologie et Culture (Français)",
	...
	{
		label: "Revista de Biología Tropical (International Journal of Tropical Biology and Conservation)",
	...
	{
		label: "Revue d'élevage et de médecine vétérinaire des pays tropicaux (Français)",
	...
	{
		label: "RöFo: Fortschritte auf dem Gebiet der Röntgenstrahlen und bildgebenden Verfahren",
		id: "rofo",
	...
	{
		label: "Ruhr-Universität Bochum - Lehrstuhl für Industrial Sales and Service Engineering",
	...
	{
		label: "Ruhr-Universität Bochum - Medizinische Fakultät (numerisch, Deutsch)",
	...
	{
		label: "Société Française d’Étude de la Céramique Antique en Gaule (Français)",
	...
	{
		label: "Société Nationale des Groupements Techniques Vétérinaires (Français)",
	...
	{
		label: "Sorbonne Student Law Review - Revue juridique des étudiants de la Sorbonne",
	...
	{
		label: "Tagungsberichte der Historischen Kommission für ost- und westpreußische Landesforschung (Deutsch)",
	...
	{
		label: "TATuP - Zeitschrift für Technikfolgenabschätzung in Theorie und Praxis",
	...
	{
		label: "Technische Universität Dresden - Betriebswirtschaftslehre/Logistik (author-date)",
	...
	{
		label: "Technische Universität Dresden - Betriebswirtschaftslehre/Marketing (author-date)",
	...
	{
		label: "Technische Universität Dresden - Betriebswirtschaftslehre/Rechnungswesen/Controlling (Deutsch)",
	...
	{
		label: "Technische Universität Dresden - Erziehungswissenschaften (author-date)",
	...
	{
		label: "Technische Universität Dresden - Finanzwirtschaft und Finanzdienstleistungen (author-date, with short titles)",
	...
	{
		label: "Technische Universität Dresden - Finanzwirtschaft und Finanzdienstleistungen (author-date)",
	...
	{
		label: "Technische Universität Dresden - Finanzwirtschaft und Finanzdienstleistungen (note)",
	...
	{
		label: "Technische Universität Dresden - Forstwissenschaft (author-date, Deutsch)",
	...
	{
		label: "Technische Universität Dresden - Historische Musikwissenschaft (note, Deutsch)",
	...
	{
		label: "Technische Universität Dresden - Medienwissenschaft und Neuere Deutsche Literatur (note, Deutsch)",
	...
	{
		label: "Technische Universität Dresden - Wirtschaftswissenschaften (Deutsch)",
	...
	{
		label: "Thèse de Sorbonne Université (Sciences Humaines et Sociales, Français)",
	...
	{
		label: "UCLouvain - Centre Charles De Visscher pour le droit international et européen (French)",
	...
	{
		label: "Uludağ Üniversitesi - Sosyal Bilimler Enstitüsü (author-date, Türkçe)",
	...
	{
		label: "Uludağ Üniversitesi - Sosyal Bilimler Enstitüsü (full note, with Ibid., Türkçe)",
	...
	{
		label: "Uludağ Üniversitesi - Sosyal Bilimler Enstitüsü (full note, Türkçe)",
	...
	{
		label: "Uludağ Üniversitesi - Sosyal Bilimler Enstitüsü - İlahiyat Fakültesi (full note, with Ibid., Türkçe)",
	...
	{
		label: "Uludağ Üniversitesi - Sosyal Bilimler Enstitüsü - İlahiyat Fakültesi (full note, Türkçe)",
	...
	{
		label: "Universidade de São Paulo - Escola de Comunicações e Artes - ABNT (Português - Brasil)",
	...
	{
		label: "Universidade do Estado do Rio de Janeiro - ABNT (Português - Brasil)",
	...
	{
		label: "Universidade do Porto - Faculdade de Engenharia - Chicago Manual of Style 17th (author-date) (Português - Portugal)",
	...
	{
		label: "Universidade do Porto - Faculdade de Psicologia e de Ciências da Educação - APA",
	...
	{
		label: "Universidade Estadual do Oeste do Paraná - Programa Institucional de Bolsas de Iniciação Científica (Português - Brasil)",
	...
	{
		label: "Universidade Estadual Paulista - Campus de Dracena - ABNT (autoria abreviada) (Português - Brasil)",
	...
	{
		label: "Universidade Estadual Paulista - Faculdade de Engenharia de Guaratingueta - ABNT (Português - Brasil)",
	...
	{
		label: "Universidade Federal de Sergipe - Departamento de Engenharia de Produção - ABNT (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Espírito Santo - ABNT (autoria abreviada) (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Espírito Santo - ABNT (autoria completa) (Português - Brasil)",
	...
	{
		label: "Universidade Federal do Rio de Janeiro - Instituto Alberto Luiz Coimbra de Pós-Graduação e Pesquisa de Engenharia - ABNT (Português - Brasil)",
	...
	{
		label: "University of Bologna - Liberal Arts College (Università di Bologna - Facoltà di Lettere e Filosofia) (Italiano)",
	...
	{
		label: "Universität Bern - Institut für Sozialanthropologie (Deutsch - Schweiz)",
	...
	{
		label: "Universität Bremen - Lehrstuhl für innovatives Markenmanagement (Deutsch)",
	...
	{
		label: "Universität Heidelberg - Medizinische Fakultät Mannheim (numerisch, Deutsch)",
	...
	{
		label: "Universität zu Köln - Seminar für ABWL und Finanzierungslehre (Deutsch)",
	...
	{
		label: "Université Cheikh Anta Diop - Faculté de Médecine de Pharmacie et d'Odontologie (Français)",
	...
	{
		label: "Université de Genève - Département de langue et de littérature françaises modernes (Français)",
	...
	{
		label: "Université de Picardie Jules Verne (Amiens) - Thèse de UFR de Médecine",
	...
	{
		label: "Université de Sherbrooke - Département de géomatique (Français - Canada)",
	...
	{
		label: "Université du Québec à Montréal - Département d’histoire (Français - Canada)",
	...
	{
		label: "Université du Québec à Montréal - Études littéraires et sémiologie (Français - Canada)",
	...
	{
		label: "Université du Québec à Montréal - APA - prénoms (Français - Canada)",
	...
	{
		label: "Université Laval - Département des sciences historiques (Français - Canada)",
	...
	{
		label: "Université Laval - Département d'information et de communication (Français - Canada)",
	...
	{
		label: "Université Laval - Faculté de théologie et de sciences religieuses (Français - Canada)",
	...
	{
		label: "Université Nangui Abrogoua - Sciences de la Nature - APA (Français)",
	...
	{
		label: "Van Yüzüncü Yıl Üniversitesi Fen Bilimleri Enstitüsü - Tez Yazım Stili (Türkçe)",
	...
	{
		label: "Westfälische Wilhelms-Universität Münster - Medizinische Fakultät (Deutsch)",
	...
	{
		label: "Wirtschaftsuniversität Wien - Abteilung für Bildungswissenschaft (Deutsch - Österreich)",
	...
	{
		label: "Wirtschaftsuniversität Wien - Handel und Marketing (Deutsch - Österreich)",
	...
	{
		label: "Wirtschaftsuniversität Wien - Institut für BWL des Außenhandels (Deutsch - Österreich)",
	...
	{
		label: "Wirtschaftsuniversität Wien - Institut für Transportwirtschaft und Logistik (Deutsch - Österreich)",
	...
	{
		label: "Wirtschaftsuniversität Wien - Wirtschaftspädagogik (Deutsch - Österreich)",
	...
	{
		label: "ZDfm – Zeitschrift für Diversitätsforschung und -management (Deutsch - Österreich)",
	...
	{
		label: "Zeitschrift für Antikes Christentum (Journal of Ancient Christianity) (English)",
	...
	{
		label: "ZitierGuide: Leitfaden zum fachgerechten Zitieren in rechtswissenschaftlichen Arbeiten (Roger Müller) (Deutsch - Schweiz)",
